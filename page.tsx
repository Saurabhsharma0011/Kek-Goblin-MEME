...
const RoadmapCard: React.FC<RoadmapCardProps> = ({ phase, title, icon, items }) => {
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#e8ffa3] to-[#c1ff72]">
      ...
      <header
        className={cn(
          ...
          scrolled ? "bg-white/90 backdrop-blur-md py-2 shadow-lg" : "bg-transparent py-4",
        )}
      >
        <motion.div
        ...
        >
          <Link href="/" className="flex items-center gap-2 hover:scale-105 transition-transform">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/kekegoblin%20logo%20(3)-a0JaxJzLGu6uBIZePJXpx0GQigLSQb.webp"
              alt="KekGoblin Logo"
              width={40}
              height={40}
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div whileHover={{ scale: 1.2 }} className="hover:text-green-600 transition-colors">
              <Link href="https://t.me/KekGoblin">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
      ...
      <section className="py-20 px-4">
        ...
        >
          <h2 className="text-4xl font-bold text-center mb-4 text-green-800 glow-text">
      ...
      <motion.section
        ...
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        className="py-20 px-4 bg-white/50 dark:bg-black/50"
      >
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-4xl font-bold text-center mb-12 text-green-800 dark:text-green-400 glow-text">
            Frequently Asked Questions
          </h2>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger>What is KekGoblin ($KEK)?</AccordionTrigger>
              <AccordionContent>
                KekGoblin is a 100% community-driven degen meme coin, born from the depths of Kekistan and fueled by
                Goblin Mode energy. No presale, no dev tax—just pure meme insanity on Solana.
              </AccordionContent>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>What&apos;s the tokenomics for $KEK?</AccordionTrigger>
              <AccordionContent>
                <ul className="list-disc pl-4 space-y-2">
                  <li>100% Community-Owned – No dev bags, no backroom deals</li>
                  <li>0% Tax – Buy, sell, and trade freely</li>
                  <li>Solana-Powered – Lightning-fast, low-fee transactions</li>
                  <li>Degen-Proof – If you&apos;re not in Goblin Mode, you&apos;re NGMI</li>
                </ul>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger>Where can I buy $KEK?</AccordionTrigger>
              <AccordionContent>
                Right now, you can get $KEK on Pump.fun and soon on Solana DEXs like Jupiter, Raydium & Orca.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              ...
              <motion.div whileHover={{ scale: 1.2, rotate: -10 }}>
                <Link href="https://t.me/KekGoblin" className="hover:text-green-400 transition-colors">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
